...
echo "s:@DB_HOST@:127.0.0.1:g" >> /usr/share/centreon/install/sql_macros.sed
...
echo "s:@NAGIOS_INIT_SCRIPT@:/sbin/service nagios:g" >> /usr/share/centreon/install/sql_macros.sed
...
echo "s:@EMBEDDED_PERL@::g" >> /usr/share/centreon/install/sql_macros.sed
