 ...
 */
	...
	function insertNagios($ret = array(), $brokerTab = array())
	{
        ...
        isset($ret["host_perfdata_file_template"]) && $ret["host_perfdata_file_template"] != NULL ? $rq .= "'".  CentreonDB::escape($ret["host_perfdata_file_template"])."',  " : $rq .= "NULL, ";
        isset($ret["service_perfdata_file_template"]) && $ret["service_perfdata_file_template"] != NULL ? $rq .= "'".CentreonDB::escape($ret["service_perfdata_file_template"])."',  " : $rq .= "NULL, ";
	...
	function updateNagios($nagios_id = null) {
        ...
        isset($ret["host_perfdata_file_template"]) && $ret["host_perfdata_file_template"] != NULL ? $rq .= "host_perfdata_file_template = '".  CentreonDB::escape($ret["host_perfdata_file_template"])."',  " : $rq .= "host_perfdata_file_template = NULL, ";
        isset($ret["service_perfdata_file_template"]) && $ret["service_perfdata_file_template"] != NULL ? $rq .= "service_perfdata_file_template = '".CentreonDB::escape($ret["service_perfdata_file_template"])."',  " : $rq .= "service_perfdata_file_template = NULL, ";
