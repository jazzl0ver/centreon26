...
class CentreonSession
{
	...
	public static function s_unset() {
		session_unset();
	}

	public static function unregister_var($register_var) {
		unset($_SESSION[$register_var]);
	}

	public static function register_var($register_var) {
		if (!isset($_SESSION[$register_var])) {
            $_SESSION[$register_var] = $$register_var;
		}
	}

	public static function checkSession($session_id, $pearDB) {
