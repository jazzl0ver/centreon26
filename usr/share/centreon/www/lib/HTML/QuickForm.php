...
class HTML_QuickForm extends HTML_Common
{
    ...
    */
    ...
    function createSecurityToken()
    {
        ...
        if (!isset($_SESSION['x-centreon-token-generated-at']) || !is_array($_SESSION['x-centreon-token-generated-at'])) {
    ...
    function checkSecurityToken($submittedValues)
    {
        ...
        if ($this->_tokenValidated) {
            ...
            if (isset($submittedValues['centreon_token'], $_SESSION['x-centreon-token'], $_SESSION['x-centreon-token-generated-at'])
                && is_array($_SESSION['x-centreon-token'])
                && is_array($_SESSION['x-centreon-token-generated-at'])
